  ...
  export default {
    ...
    watch: {
      currentEditData: {
        ...
        immediate: true,
        handler () {
          this.form = Object.assign({}, this.currentEditData, { addressData: [TextToCode[this.currentEditData.province].code, TextToCode[this.currentEditData.province][this.currentEditData.city].code, TextToCode[this.currentEditData.province][this.currentEditData.city][this.currentEditData.county].code] })
        }
      }
    },
    methods: {
